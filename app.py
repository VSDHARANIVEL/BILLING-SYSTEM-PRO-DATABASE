...
<title>Billing System Pro</title>
<style>
  ...
  <div class="content">
    ...
    <div class="pg" id="pg-stock">
      ...
      <div class="card">
        ...
        <div class="fr">
          <div class="fg" style="max-width:165px"><label>Product Code (3 digits)</label><input id="pCode" type="text" maxlength="3" placeholder="e.g. 114" onkeydown="ek(event,'pName')"/></div>
